class Content_compensation_committee_ch extends React.Component {
    constructor(props){
        super(props);
        this.state={
            ...
            data:{
                ...
                list2:[
                    {title:"(一)以善良管理人之注意， 忠實履行下列職權， 並將所提建議提交董事會討論：",contents:[
                        "1. 訂定並定期檢討董事、監察人及經理人績效評估與薪資報酬之政策、制度、標準與結構。",
                        "2. 訂定並定期評估董事、監察人及經理人之薪資報酬。",
                        "3. 對監察人報酬之建議， 以公司章程明定(或股東會決議)授權董事會辦理者為限。",
                        "4. 子公司董事及經理人之薪資報酬， 依公司規定需經母公司董事會核定者， 應先請母公司薪資報酬委員會提出建議。"
                    ]},
                    {title:"(二)薪資報酬之定義：",contents:[
                        "1. 現金",
                        "2. 認股權",
                        "3. 分紅入股",
                        "4. 退休福利",
