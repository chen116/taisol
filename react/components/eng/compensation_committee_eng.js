function Page_compensation_committee_eng(props) {
    const myPage = "compensation_committee_eng";
    var data = {
      salary_regulations: [
        {   
            "title":"第 一 條　訂定目的及依據", 
            ...
            <div class="accordion" id="accordionExample">
                <div class="card">
                    ...
                    <div id="collapseOne" class="collapse" aria-labelledby="headingOne" >
                        ...
                        <ActiveList1  data={data.salary_regulations} />
                        </div>
                              ...
                              <li class="list-group-item">(2)   本屆委員任期：107年6月19日至110年6月18日，最近年度(108年度至年報刊印日止)薪資報酬委員會開會 5 次(Ａ)，委員資格及出席情形如下：
                                  ...
                                  <ul class="list-group list-group-flush ">
                                    <li class="list-group-item">其他應記載事項：
                                      ...
                                      <li class="list-group-item">
                                          <ActiveList2 data={data.meetings} />
                                      </li>
