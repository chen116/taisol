function Page_regulations_eng(props) {
    const myPage = "regulations_eng";
    ...
    return [
        <div class="content">
            <h4 style={{color:`blue`}}><img class="rounded" src="./assets/images/bullet.jpg"/><span>&nbsp;&nbsp;</span>Regulations &#38; Legislations </h4>
            <p><span>&nbsp;&nbsp;</span></p> 
