function Page_shareholder_relations_eng(props) {
  const myPage = "shareholder_relations_eng";
  if (myPage != props.currentPage){return null;}
    ...
    <div class="content">
      ...
      <h4 style={{color:`blue`}}><img class="rounded" src="./assets/images/bullet.jpg"/><span>&nbsp;&nbsp;</span>Shareholder Relations </h4>
      <p><span>&nbsp;&nbsp;</span></p>
