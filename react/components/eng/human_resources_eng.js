function Page_human_resources_eng(props) {
  const myPage = "human_resources_eng";
  if (myPage != props.currentPage){return null;}
      ...
      <div class="content">
        ...
        <h4 style={{color:`blue`}}><img class="rounded" src="./assets/images/bullet.jpg"/><span>&nbsp;&nbsp;</span>Human Resources </h4>
        <p><span>&nbsp;&nbsp;</span></p>
