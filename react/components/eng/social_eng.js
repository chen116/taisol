function Page_social_eng(props) {
  const myPage = "social_eng";
  if (myPage != props.currentPage){return null;}
    ...
    return [
        <div class="content">
            <h4 style={{color:`blue`}}><img class="rounded" src="./assets/images/bullet.jpg"/><span>&nbsp;&nbsp;</span>Social Responsibility </h4>
            <p><span>&nbsp;&nbsp;</span></p>  
